...
require("./app/routing/html-routes.js")(app);//first we go to the html route
require("./app/routing/auth-routes.js")(app);//any request has always to got through this Authentication route.
require("./app/routing/api-routes.js")(app);//this is our api. It will be accesses only after the "./app.routing/auth-routes.js" requirements are satisfied.
